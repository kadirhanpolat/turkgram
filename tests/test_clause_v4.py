...
def test_trailing_bare_subordinator_robust():
    ...
    # cümle-başı ki → tek yan (best-effort), çökme yok
    assert analyze_sentence("ki gelecek", roots=_ROOTS).clauses[0].role == "yan"
